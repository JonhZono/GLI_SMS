...
import { getExamById, clearViewExam } from '../../../actions/exam';
...
class EditExamIndex extends Component {
  componentDidMount() {
    ...
    this.props.dispatch(getExamById(match.params.exam_id));
  }
  componentWillUnmount = () => {
    this.props.dispatch(clearViewExam());
  };
  render() {
    return this.props.exam.getExamById === null ? (
      <UserLayout>
        <div
      ...
      <EditExam
        ...
        studentExamById={this.props.exam.getExamById}
