...
import { getEikenExamById, clearViewExam } from '../../../actions/exam';
...
class EditExamIndex extends Component {
  componentDidMount() {
    ...
    this.props.dispatch(getEikenExamById(match.params.exam_id));
  }
  componentWillUnmount = () => {
    this.props.dispatch(clearViewExam());
  };
  render() {
    return this.props.exam.getEikenExamById === null ? (
      <UserLayout>
        <div
      ...
      <EditExam
        ...
        studentEikenExamById={this.props.exam.getEikenExamById}
