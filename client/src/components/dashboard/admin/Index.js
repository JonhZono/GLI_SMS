...
const AdminProfile = props => {
  ...
  return props.profile.loading && props.profile.adminProfile === null ? (
    <UserLayout>
      <div
          ...
          <div className='columns'>
            <div className='column'>
              <div className='card has-text-centered'>
                ...
                {props.profile.adminProfile !== null ? (
                  <ProfileInfoAdmin
                    adminProfile={props.profile.adminProfile}
